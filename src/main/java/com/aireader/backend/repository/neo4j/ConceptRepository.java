...
import com.aireader.backend.model.neo4j.Concept;
...
public interface ConceptRepository extends Neo4jRepository<Concept, Long> {
     ...
     * @return 概念节点Optional包装
     */
    Optional<Concept> findByNameAndType(String name, Concept.ConceptType type);
     ...
     * @return 概念列表
     */
    List<Concept> findByType(Concept.ConceptType type);
    ...
    List<Concept> findConceptsByArticle(@Param("articleMysqlId") String articleMysqlId);
    ...
    List<Concept> findTopConcepts(@Param("limit") int limit);
    ...
    List<Concept> findCommonConceptsBetweenArticles(
